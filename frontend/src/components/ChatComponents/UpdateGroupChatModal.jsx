...
export default function UpdateGroupChatModal({ userData, token, fetchChatAgain, setFetchChatAgain, fetchMessages }) {
    ...
    const handleAddUser = async(selecteduser)=>{
        ...
        try {
            ...
            const response = await fetch(`https://chatconnect-app.onrender.com/api/chat/addtogroup`, {
                method: "PUT",
                headers: {
    ...
    const handleRemove = async(selecteduser) => {
        ...
        try {
            ...
            const response = await fetch(`https://chatconnect-app.onrender.com/api/chat/removefromgroup`, {
                method: "PUT",
                headers: {
                    Authorization: `Bearer ${token}`,
                    'Content-Type': 'application/json'
    ...
    const handleRename = async() => {
        ...
        try {
            ...
            const response = await fetch(`https://chatconnect-app.onrender.com/api/chat/rename`, {
                            method: "PUT",
                            headers: {
                                'Content-Type': 'application/json', 
                                Authorization: `Bearer ${token}`,
